...
const CTAFinal = () => {
  return (
    <section className="w-full bg-charcoal py-16 sm:py-24 px-4 sm:px-6 flex justify-center items-center min-h-[320px] sm:min-h-[420px] font-body">
      <div className="max-w-screen-xl w-full mx-auto bg-surface border border-white/5 text-cream rounded-[2rem] sm:rounded-[3rem] shadow-xl flex flex-col items-center justify-center px-5 sm:px-8 py-10 sm:py-16 relative overflow-hidden transition-colors hover:border-white/10">
