  ...
  return (
    <section className="w-full bg-dark-bg pb-16 sm:pb-24 px-4 sm:px-6 flex justify-center items-center min-h-[320px] sm:min-h-[420px]">
      <div className="max-w-screen-xl w-full mx-auto bg-gradient-to-br from-secondary via-secondary to-secondary700 rounded-[28px] sm:rounded-[48px] shadow-xl flex flex-col items-center justify-center px-5 sm:px-8 py-10 sm:py-16">
        <h2 className="font-title text-2xl sm:text-3xl md:text-5xl font-extrabold text-white text-center mb-4 sm:mb-6 text-balance">Pronto para dar o próximo passo com sua marca?</h2>
        <p className="text-base sm:text-lg md:text-xl text-white/80 font-light text-center mb-8 sm:mb-10">Se você sente que já passou da hora da sua marca acompanhar o nível do seu trabalho, o próximo passo é simples. Conte um pouco sobre seu momento para que o Svicero Studio possa te orientar com clareza.</p>
