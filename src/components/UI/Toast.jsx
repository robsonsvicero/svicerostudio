...
const Toast = ({ show, message, type = 'success', onClose }) => {
  ...
  return (
    <div className={`fixed top-8 right-8 z-50 min-w-[320px] max-w-[450px] p-6 bg-white rounded-xl shadow-2xl flex items-center justify-between gap-4 font-body animate-slideInRight border-l-4 ${type === 'success' ? 'border-green-500' : 'border-red-500'}`}>
