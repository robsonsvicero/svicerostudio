    ...
    <section className="py-16 sm:py-24 px-4 sm:px-6 md:px-16 font-body">
      <div className="max-w-screen-xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-10 items-start">
        ...
        <ScrollReveal direction="right" delay={0.1}>
          ...
          <p className="text-xl font-normal leading-[1.6] text-ds-muted mb-4">
          ...
          <p className="text-base font-normal leading-[1.6] text-ds-muted mb-6">
          ...
          <ul className="text-base font-normal leading-[1.6] text-ds-muted space-y-3 mt-4">
            <li className="flex gap-3 items-center"><span className="w-1.5 h-1.5 bg-ds-accent rounded-full"></span> Duração média de 45 a 60 minutos, realizada online de forma individual.</li>
            <li className="flex gap-3 items-center"><span className="w-1.5 h-1.5 bg-ds-accent rounded-full"></span> Foco em estrutura de tratamentos, público local e diferenciação estética.</li>
            <li className="flex gap-3 items-center"><span className="w-1.5 h-1.5 bg-ds-accent rounded-full"></span> Você sai com clareza exata sobre o ruído visual que está afastando o paciente particular.</li>
          </ul>
        </ScrollReveal>
        ...
        <ScrollReveal direction="left" delay={0.2} className="bg-ds-surface border border-white/5 hover:border-white/10 shadow-lg rounded-[2rem] p-8 md:p-10 flex flex-col justify-between relative overflow-hidden transition-colors">
          ...
          <div className="relative z-10">
            ...
            <ul className="text-base font-normal leading-[1.6] text-ds-muted mb-6 space-y-3">
            ...
            <p className="text-sm font-normal leading-[1.6] text-ds-muted mb-8">
