            ...
            <div className="bg-[#141414]/60 backdrop-blur-xl border border-white/5 shadow-2xl rounded-[2rem] p-8 md:p-12 space-y-8">
              ...
              <section>
                ...
                <div className="bg-[#1A1A1A] border border-white/5 rounded-[1.25rem] p-6 mb-4">
                  <h3 className="text-lg font-medium tracking-tight text-ds-text mb-3">
                    Passo 1: Entre em Contato
                  </h3>
                  <p className="text-ds-muted mb-4 leading-[1.6]">
                    Envie um e-mail para:
                  </p>
                  <a
                    href="mailto:hello@svicerostudio.com.br?subject=Solicitação de Exclusão de Dados"
                    className="inline-flex items-center gap-2 px-6 py-3 bg-white/5 border border-white/10 hover:bg-white/10 text-ds-text rounded-full transition-colors font-medium"
                  >
                ...
                <div className="bg-[#1A1A1A] border border-white/5 rounded-[1.25rem] p-6 mb-4">
                  ...
                  <p className="text-ds-muted mb-3 leading-[1.6]">
                    No e-mail, inclua:
                  </p>
                  <ul className="list-disc list-inside text-ds-muted space-y-2 ml-4">
              ...
              <section>
                ...
                <ol className="list-decimal list-inside text-ds-muted space-y-3 ml-4">
              ...
              <section>
                ...
                <p className="text-ds-muted leading-[1.6]">
                  ...
                  <br />
                  <a href="mailto:hello@svicerostudio.com.br" className="text-ds-accent hover:text-ds-accent/80 hover:underline font-medium">
                    hello@svicerostudio.com.br
                  </a>
                </p>
              </section>
