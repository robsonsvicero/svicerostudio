    ...
    <>
      ...
      <div className="bg-ds-bg min-h-screen text-ds-text font-body">
        ...
        <section className="mx-auto max-w-7xl px-6 py-16 lg:px-10 lg:py-20">
          <div className="grid gap-12 lg:grid-cols-2 lg:gap-16 items-start">
            <ScrollReveal direction="right" delay={0.1}>
              <div>
                <p className="text-[10px] uppercase tracking-widest text-ds-accent font-mono">
                  Contato direto
                </p>
              ...
              {channels.map((channel, idx) => (
                <ScrollReveal direction="up" delay={0.1 + idx * 0.15} key={channel.title}>
                  <a
                    ...
                    className="group rounded-3xl border border-white/5 hover:border-white/10 bg-ds-surface px-8 py-6 transition duration-300 hover:shadow-lg hover:-translate-y-1 block shadow-sm h-full"
                  >
                    <p className="text-[10px] uppercase tracking-widest text-ds-muted font-mono">
                      {channel.title}
                    </p>

                    <h3 className="mt-2 text-xl font-medium text-ds-text group-hover:text-ds-accent transition-colors">
                      {channel.value}
                    </h3>

                    <p className="mt-2 text-sm leading-[1.6] text-ds-muted">
                      {channel.description}
                    </p>
                  </a>
                </ScrollReveal>
        ...
        <section className="mx-auto max-w-7xl px-6 pb-16 lg:px-10 lg:pb-20">
          <ScrollReveal direction="up" delay={0.1}>
            <div className="rounded-[2rem] border border-white/5 hover:border-white/10 transition-colors bg-ds-surface p-10 shadow-sm">
              <p className="text-[10px] uppercase tracking-widest text-ds-accent font-mono">
                Tempo de resposta
              </p>

              <h3 className="mt-3 text-2xl font-medium tracking-tight text-ds-text">
