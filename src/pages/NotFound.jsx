...
const NotFound = () => {
  return (
    <>
      ...
      <div className="bg-ds-bg min-h-screen flex flex-col font-body relative overflow-hidden">
        ...
        <main className="flex-1 flex flex-col items-center justify-center px-4 py-24 text-center relative z-10">
          ...
          <h1 className="text-3xl md:text-5xl font-medium tracking-tight text-ds-text mb-4 text-balance">404 – Página não encontrada</h1>
          <p className="text-ds-muted text-lg leading-[1.6] mb-8 max-w-xl mx-auto">
