...
const Login = () => {
  ...
  return (
    <div className="min-h-screen bg-ds-bg flex flex-col items-center justify-center px-4 font-body relative overflow-hidden">
      ...
      <div className="w-full max-w-md flex flex-col gap-6 relative z-10">
        ...
        <div className="text-center">
          ...
          />
          <h1 className="text-[1.875rem] md:text-4xl font-medium tracking-tight text-ds-text mb-2">
            Área Administrativa
          </h1>
        ...
        <div className="bg-ds-surface backdrop-blur-xl rounded-[2rem] p-8 border border-white/5 shadow-2xl">
          <form onSubmit={handleSubmit} className="flex flex-col gap-6">
            ...
            <div>
              <label htmlFor="email" className="block text-ds-text text-sm font-medium mb-2">
                E-mail
              </label>
              <input
                type="email"
            ...
            <div>
              <label htmlFor="password" className="block text-ds-text text-sm font-medium mb-2">
                Senha
              </label>
              <div className="relative">
                ...
                <button
                  ...
                  className="absolute right-3 top-1/2 -translate-y-1/2 text-ds-muted hover:text-ds-accent transition-colors p-1 bg-transparent border-none outline-none focus:outline-none"
                  tabIndex={-1}
                >
        ...
        <div className="text-center">
          <a 
            href="/" 
            className="text-ds-muted hover:text-ds-text transition-colors text-sm font-medium inline-flex items-center gap-2"
          >
