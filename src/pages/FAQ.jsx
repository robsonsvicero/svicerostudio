...
const FAQ = () => {
  ...
  return (
    <div className="bg-ds-bg min-h-screen flex flex-col text-ds-text font-body relative overflow-hidden">
      ...
      <main className="flex-1 relative z-10">
        ...
        <section className="mx-auto max-w-3xl px-6 py-8 lg:px-10 lg:py-12">
          <div className="space-y-8">
            {loading ? (
              <div className="text-center text-ds-muted py-8">Carregando perguntas...</div>
            ) : perguntas.length === 0 ? (
