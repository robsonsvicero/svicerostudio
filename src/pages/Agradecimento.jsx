  ...
  <div className="min-h-screen flex items-center justify-center bg-ds-bg px-4 py-12 font-body relative overflow-hidden">
    ...
    <div className="max-w-lg w-full bg-[#141414]/60 backdrop-blur-xl rounded-[2rem] p-8 md:p-12 text-left border border-white/5 shadow-2xl relative z-10">
      ...
      <span className="flex justify-center mb-6">
        <span className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full border border-ds-accent/25 bg-ds-accent/5 text-[11px] font-mono uppercase tracking-[.2em] text-ds-accent">
          <span className="w-1.5 h-1.5 rounded-full bg-ds-accent shadow-[0_0_10px_rgba(184,115,51,0.5)]" />
          SOLICITAÇÃO RECEBIDA
        </span>
      </span>

      <h1 className="text-2xl md:text-3xl font-medium tracking-tight text-ds-text mb-6 text-center">
        Recebemos sua solicitação com sucesso.
      </h1>
      
      <p className="text-ds-muted leading-[1.6] mb-6 text-base">
      ...
      <p className="text-ds-muted leading-[1.6] mb-8 text-base text-center">
