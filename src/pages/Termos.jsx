      ...
      <div className="min-h-screen bg-ds-bg font-body relative overflow-hidden">
        ...
        <main className="pt-28 sm:pt-36 md:pt-[200px] pb-16 sm:pb-24 px-4 sm:px-6 md:px-16 relative z-10">
          <div className="max-w-4xl mx-auto">
            <h1 className="text-4xl md:text-[3.75rem] font-medium tracking-[-0.02em] leading-[1.1] text-ds-text text-left mb-6">
            ...
            <div className="bg-[#141414]/60 backdrop-blur-xl border border-white/5 shadow-2xl rounded-[2rem] p-8 md:p-12 space-y-8">
              ...
              <section>
                ...
                <div className="space-y-4 text-ds-muted leading-[1.6]">
                  ...
                  <p>
                    E-mail: <a href="mailto:hello@svicerostudio.com.br" className="text-ds-accent hover:underline">hello@svicerostudio.com.br</a><br />
                    WhatsApp: <a href="https://wa.me/5511964932007" target="_blank" rel="noopener noreferrer" className="text-ds-accent hover:underline">+55 (11) 96493-2007</a>
                  </p>
              ...
              <section>
                ...
                <div className="space-y-4 text-ds-muted leading-[1.6]">
                  ...
                  <p>
                    ...
                    E-mail: <a href="mailto:hello@svicerostudio.com.br" className="text-ds-accent hover:underline">hello@svicerostudio.com.br</a><br />
                    WhatsApp: <a href="https://wa.me/5511964932007" target="_blank" rel="noopener noreferrer" className="text-ds-accent hover:underline">+55 (11) 96493-2007</a><br />
